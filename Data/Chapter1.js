const CHAPTER1 = [
  ...
  {
    question: "R3. Why are standards important for protocols?",
    answer:
  ...
  },
  {
    ...
    answer:
      "4. <br>1. Dial-up modem over telephone line: home; <br>2. DSL over telephone line: home or small office; <br>3. Cable to HFC: home; <br>4. 100 Mbps switched Ethernet: enterprise; <br>5. Wifi (802.11): home and enterprise: <br>6. 3G and 4G: wide-area wireless.",
    section: "1.2",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "9. Dial up modems: up to 56 Kbps, bandwidth is dedicated;<br> ADSL: up to 24 Mbps downstream and 2.5 Mbps upstream, bandwidth is dedicated;<br> HFC, rates up to 42.8 Mbps and upstream rates of up to 30.7 Mbps, bandwidth is shared.<br> FTTH: 2-10Mbps upload; 10-20 Mbps download; bandwidth is not shared.",
    section: "1.2",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "11. At time t 0 the sending host begins to transmit. At time t 1 = L/R 1 , the sending host completes transmission and the entire packet is received at the router (no propagation delay). Because the router has the entire packet at time t 1 , it can begin to transmit the packet to the receiving host at time t 1 . At time t 2 = t 1 + L/R 2 , the router completes transmission and the entire packet is received at the receiving host (again, no propagation delay). Thus, the end-to-end delay is L/R 1 + L/R 2 .",
    section: "1.3",
  },
  {
    question:
  ...
  {
    question: `R13. Suppose users share a 2 Mbps link. Also suppose each user transmits continuously at 1 Mbps when transmitting, but each user transmits only 20 percent of the time. <br> 
      <ol type="a" >
        <li> When circuit switching is used, how many users can be supported? </li>
        <li> For the remainder of this problem, suppose packet switching is used. Why will there be essentially no queuing delay before the link if two or fewer users transmit at the same time? Why will there be a queuing delay if three users transmit at the same time? </li>
        <li>  Find the probability that a given user is transmitting. </li>
        <li> Suppose now there are three users. Find the probability that at any given time, all three users are transmitting simultaneously. Find the fraction of time during which the queue grows. </li>
      </ol>   `,
    answer: `13. 
      <ol type="a" >
      <li> 2 users can be supported because each user requires half of the link bandwidth. </li>
      <li> Since each user requires 1Mbps when transmitting, if two or fewer users transmit simultaneously, a maximum of 2Mbps will be required. Since the available bandwidth of the shared link is 2Mbps, there will be no queuing delay before the link. Whereas, if three users transmit simultaneously, the bandwidth required will be 3Mbps which is more than the available bandwidth of the shared link. In this case, there will be queuing delay before the link.  </li>
      <li> Probability that a given user is transmitting = 0.2 </li>
      <li> Probability that all three users are transmitting simultaneously = (0.2)^3 = 0.008.  Since the queue grows when all the users are transmitting, the fraction of time during which the queue grows (which is equal to the probability that all three users are transmitting simultaneously) is 0.008. </li>
      </ol>
      `,
    section: "1.3",
  },
  ...
  },
  {
    ...
    answer: "17. a) 1000 km, 1 Mbps, 100 bytes b) 100 km, 1 Mbps, 100 bytes",
    section: "1.4",
  },
  {
    question:
      "R18. A user can directly connect to a server through either long-range wireless or a twisted-pair cable for transmitting a 1500-bytes file. The transmission rates of the wireless and wired media are 2 and 100 Mbps, respectively. Assume that the propagation speed in air is 3*10^8 m/s, while the speed in  the twisted pair is 2*10^8 m/s. If the user is located 1 km away from the server, what is the nodal delay when using each of the two technologies?",
    answer: "18. 10msec; d/s; no; no",
    section: "1.4",
  },
  {
    question:
      "R19. Suppose Host A wants to send a large file to Host B. The path from Host A to Host B has three links, of rates R 1 = 500 kbps, R 2 = 2 Mbps, and R 3 = 1 Mbps. a. Assuming no other traffic in the network, what is the throughput for the file transfer? b. Suppose the file is 4 million bytes. Dividing the file size by the throughput, roughly how long will it take to transfer the file to Host B? c. Repeat (a) and (b), but now with R 2 reduced to 100 kbps.",
    answer: "19. a) 500 kbps b) 64 seconds c) 100kbps; 320 seconds",
    section: "1.4",
  },
  {
    question:
  ...
  {
    question:
      "R26. You are in a university classroom and you want to spy on what websites your classmates are visiting with their laptops during the course lecture. If they all connect to the Internet through the university\u2019s WiFi network, what could you do?",
    answer:
      "26. a) Virus Requires some form of human interaction to spread. Classic example: E-mail viruses. b) Worms No user replication needed. Worm in infected host scans IP addresses and port numbers, looking for vulnerable processes to infect.",
    section: "1.6",
  },
  {
    question:
